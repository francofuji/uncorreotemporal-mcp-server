...
import { C, FONT_SANS, WIDTH, HEIGHT } from "../constants";
...
const TOOLS = [
  ...
  { name: "complete_signup_flow",       description: "Do all of the above in one call" },
];

export const SolutionTools: React.FC = () => {
  ...
  const subheadingOpacity = interpolate(frame, [15, 35], [0, 1], {
    extrapolateLeft: "clamp",
    extrapolateRight: "clamp",
  });
  ...
  return (
    ...
    >
      ...
      <div style={{ textAlign: "center", marginBottom: 8 }}>
        ...
        >
          The agent discovers them automatically via{" "}
          <span style={{ color: C.accent, fontWeight: 600 }}>tools/list</span>
